  ...
  return (
    <Card className="w-[400px] h-[620px] fantasy-card rounded-lg overflow-hidden border-none">
      <CardContent className="p-0 h-full flex flex-col">
        ...
        <div className="flex flex-col h-[316px] items-start relative w-full bg-[#2f2f2f] rounded-[8px_8px_0px_0px] flex-1">
          <div className="w-full font-inter font-normal text-[#ffffffcc] text-[32px] text-center tracking-[0] leading-[72px]">
            {state.selectedPlayer?.name || "Select a player"}
          </div>

          <div className="w-full font-inter font-normal text-[#ffffffcc] text-9xl text-center tracking-[0] leading-[172px]">
            {state.selectedPlayer?.points || "0"}
          </div>

          <div className="w-full font-inter font-normal text-[#ffffffcc] text-base text-center tracking-[0] leading-4">
            Points
          </div>
        </div>
      </CardContent>
